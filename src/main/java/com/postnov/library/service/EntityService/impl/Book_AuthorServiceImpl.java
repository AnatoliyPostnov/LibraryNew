...
public class Book_AuthorServiceImpl implements Book_AuthorService {
    ...
    @Override
    public void saveAuthorsIdAndBookId(List<Long> authors_id, Long book_id) {
    ...
    @Override
    public Set<Long> getAuthorsIdByBookId(Long book_id) {
        return book_authorRepository.findAuthorsIdByBookId(book_id);
    }

    @Override
    public Long getBookIdByAuthorId(Long author_id) {
